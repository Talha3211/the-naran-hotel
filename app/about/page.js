...
export default function Page() {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-x-8 gap-y-16 lg:gap-x-24 lg:gap-y-32 text-lg items-center px-4 sm:px-8">
      <div className="lg:col-span-3">
        <h1 className="text-3xl lg:text-4xl mb-6 lg:mb-10 text-accent-400 font-medium">
          Welcome to The Naran Hotel
        </h1>
      ...
      <div className="lg:col-span-3">
        ...
        <div className="space-y-6 lg:space-y-8">
          <p>
            Since 1962, The Naran Hotel has been a cherished family-run retreat.
